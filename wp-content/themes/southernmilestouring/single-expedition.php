    ...
    if ($post_tags) {
      foreach ($post_tags as $tag) {
        ...
        if (in_array($slug, ['mountains', 'mountain'])) {
          ...
          $terrain_icon = 'fa-[#ff5a00] fa-mountain';
          break;
        } elseif (in_array($slug, ['beaches', 'coastal', 'beach'])) {
          $terrain_type = 'COASTAL';
          $terrain_icon = 'fa-[#ff5a00] fa-[#ff5a00] fa-water';
          break;
...
<div class="bg-black text-white min-h-screen uppercase tracking-tighter selection:bg-[#ff5a00] selection:text-black">
  ...
  <main class="relative py-8 px-4 md:px-8 overflow-hidden min-h-screen">
    ...
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div class="absolute top-1/3 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-[#ff5a00]/30 to-transparent animate-[stream_10s_linear_infinite]"></div>
    ...
    <div class="relative z-10 max-w-6xl mx-auto">
      ...
      <div class="mb-8 flex items-center justify-between border-b border-white/10 pb-4">
        <a href="javascript:history.back()" class="inline-flex items-center gap-2 text-xs text-gray-400 hover:text-[#ff5a00] font-black tracking-widest transition-colors group">
          <i class="fa-solid fa-arrow-left text-[#ff5a00] group-hover:-translate-x-1 transition-transform"></i>
      ...
      <section class="relative mb-12 bg-black border-2 border-white/10 group shadow-2xl overflow-hidden"> 
        ...
        <!-- Corner Brackets -->
        <div class="absolute top-3 left-3 w-4 h-4 border-t-2 border-l-2 border-[#ff5a00] z-20 pointer-events-none"></div>
        <div class="absolute top-3 right-3 w-4 h-4 border-t-2 border-r-2 border-[#ff5a00] z-20 pointer-events-none"></div>
        <div class="absolute bottom-3 left-3 w-4 h-4 border-b-2 border-l-2 border-[#ff5a00] z-20 pointer-events-none"></div>
        <div class="absolute bottom-3 right-3 w-4 h-4 border-b-2 border-r-2 border-[#ff5a00] z-20 pointer-events-none"></div>

        <!-- Radar Sweep Line -->
        <div class="absolute inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-[#ff5a00]/50 to-transparent animate-[radar_6s_ease-in-out_infinite] z-20 pointer-events-none"></div>
        ...
        <div class="absolute bottom-4 left-4 right-4 z-20 flex flex-wrap items-center justify-between gap-4">
          <div class="inline-flex items-center gap-2 bg-black/80 border border-[#ff5a00]/50 px-3 py-1 text-[10px] font-black text-[#ff5a00] tracking-widest backdrop-blur-md">
      ...
      <div class="grid lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-8 space-y-8">
          ...
          <div class="border-l-4 border-[#ff5a00] pl-6 py-2">
        ...
        <div class="lg:col-span-4">
          <div class="sticky top-8 bg-[#0a0a0a]/95 border border-white/15 p-6 md:p-8 flex flex-col space-y-8 shadow-2xl backdrop-blur-md relative overflow-hidden">
            <div>
              <span class="text-[11px] font-black tracking-[0.2em] text-[#ff5a00] uppercase block mb-2 flex items-center gap-2">
                <i class="fa-solid fa-microchip"></i>
                TELEMETRY
              </span>
              <div class="h-[2px] w-full bg-gradient-to-r from-[#ff5a00] via-white/20 to-transparent"></div>
            </div>

            <div class="space-y-6">              
              <!-- Dates Card -->
              <div class="flex items-start gap-4 p-3 bg-black/60 border border-white/5">
                <span class="text-[#ff5a00] text-xl mt-0.5"><i class="fa-solid fa-calendar-days"></i></span>
                <div>
              ...
              <!-- Distance Card -->
              <div class="flex items-start gap-4 p-3 bg-black/60 border border-white/5">
                <span class="text-[#ff5a00] text-xl mt-0.5"><i class="fa-solid fa-route"></i></span>
                <div>
            ...
            <div class="pt-4 border-t border-white/10 flex flex-col space-y-3">
              <div class="flex items-center justify-between">
                <span class="text-[10px] font-black tracking-widest text-[#ff5a00] uppercase block">
              ...
              <div class="relative w-full aspect-video bg-black border border-white/15 overflow-hidden group">
                ...
                <!-- Crosshair Accents -->
                <div class="absolute top-1 left-1 text-[8px] text-[#ff5a00] font-mono pointer-events-none z-20">+</div>
                <div class="absolute top-1 right-1 text-[8px] text-[#ff5a00] font-mono pointer-events-none z-20">+</div>
                <div class="absolute bottom-1 left-1 text-[8px] text-[#ff5a00] font-mono pointer-events-none z-20">+</div>
                <div class="absolute bottom-1 right-1 text-[8px] text-[#ff5a00] font-mono pointer-events-none z-20">+</div>
                ...
                <?php else: ?>
                  ...
                  <div class="w-full h-full bg-[#050505] flex flex-col items-center justify-center p-4 text-center relative overflow-hidden">
                    <svg class="absolute inset-0 w-full h-full opacity-20 text-[#ff5a00]" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <i class="fa-solid fa-map text-2xl text-[#ff5a00] mb-2 animate-pulse"></i>
            ...
            <div class="pt-2">
              <?php if ($ride_link) : ?>
                <a href="<?php echo esc_url($ride_link); ?>" target="_blank" class="block w-full group">
                  <button class="w-full bg-[#ff5a00] hover:bg-white text-black py-4 px-6 text-xs font-black tracking-[0.2em] transition-all duration-300 flex items-center justify-center gap-3 uppercase shadow-[0_0_20px_rgba(255,90,0,0.3)]">
