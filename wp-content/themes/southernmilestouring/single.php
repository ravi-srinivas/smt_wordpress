...
<div class="bg-black text-white min-h-screen uppercase tracking-tighter selection:bg-[#ff5a00] selection:text-black">
  <?php while ( have_posts() ) : the_post(); ?>
    ...
    <!-- ================= HERO HEADER ================= -->
    <header class="relative h-[55vh] md:h-[70vh] overflow-hidden bg-black border-b-4 border-[#ff5a00] group select-none">
      ...
      <div class="absolute inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-[#ff5a00]/40 to-transparent animate-[radar_6s_ease-in-out_infinite] pointer-events-none z-10"></div>
      ...
      <div class="relative z-20 flex flex-col items-center justify-end h-full text-center text-white px-4 pb-12 max-w-5xl mx-auto uppercase tracking-tighter">
        <div class="inline-flex items-center gap-2 bg-black/80 border border-[#ff5a00]/40 text-[#ff5a00] px-4 py-1.5 rounded-none text-[10px] md:text-xs font-black tracking-widest shadow-2xl backdrop-blur-sm">
    ...
    <section id="main" class="relative py-12 md:py-20 text-white border-y border-white/10 tracking-tighter overflow-hidden select-none">
      ...
      <div class="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div class="text-center bg-[#0a0a0a] border border-white/10 p-8 md:p-14 mb-12 relative overflow-hidden shadow-2xl backdrop-blur-md">
          ...
          <!-- Category Pill Tag -->
          <div class="mb-6">
            <span class="bg-[#ff5a00] text-black font-black text-xs px-4 py-1.5 uppercase tracking-widest shadow-[0_0_15px_rgba(255,90,0,0.4)]">
              <?php the_category(', '); ?>
            </span>
          </div>
          ...
          <div class="w-20 h-1 bg-[#ff5a00] mx-auto mb-8 shadow-[0_0_15px_#ff5a00]"></div>
          ...
          <div class="flex flex-wrap items-center justify-center gap-4 md:gap-8 text-xs md:text-sm font-bold tracking-widest text-gray-400 border-t border-b border-white/10 py-4 px-6 bg-black/60">
            <span class="flex items-center gap-2"><i class="fa-solid fa-calendar-days text-[#ff5a00]"></i> DATE: <?php echo get_the_date(); ?></span>
            <span class="text-white/20">•</span>
            <span class="flex items-center gap-2 text-white"><i class="fa-solid fa-user-ninja text-[#ff5a00]"></i> AUTHOR: <?php the_author(); ?></span>
          </div>
        ...
        <div class="grid lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <article class="lg:col-span-8 border border-white/10 bg-[#0a0a0a]/90 p-6 md:p-12 lg:p-14 relative shadow-2xl backdrop-blur-md">
            ...
            <?php if( has_tag() ) : ?>
              <div class="mt-12 pt-8 border-t border-white/10 uppercase tracking-widest text-xs font-black flex flex-wrap gap-3 items-center">
                <span class="text-[#ff5a00] flex items-center gap-2"><i class="fa-solid fa-tags"></i> ROUTE TAGS:</span>
                <?php the_tags('<span class="bg-black text-gray-300 border border-white/15 px-3 py-1.5 hover:border-[#ff5a00] hover:text-[#ff5a00] transition-colors">', '</span><span class="bg-black text-gray-300 border border-white/15 px-3 py-1.5 hover:border-[#ff5a00] hover:text-[#ff5a00] transition-colors">', '</span>'); ?>
              </div>
            <?php endif; ?>
          ...
          <aside class="lg:col-span-4 space-y-8 uppercase">
            ...
            <div class="border border-white/10 p-8 bg-[#0a0a0a]/90 text-center shadow-xl backdrop-blur-md relative group hover:border-[#ff5a00]/40 transition-colors">
              <h4 class="text-xs font-black tracking-[0.2em] text-gray-400 mb-6 flex items-center justify-center gap-2">
                <i class="fa-solid fa-share-nodes text-[#ff5a00]"></i>
                SHARE THIS LOG
              </h4>
              <div class="flex justify-center gap-4 text-xl">
                <a href="https://facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>" target="_blank" rel="noopener noreferrer" class="w-12 h-12 border border-white/10 bg-black flex items-center justify-center text-gray-400 hover:text-[#ff5a00] hover:border-[#ff5a00] hover:scale-110 transition-all shadow-md">
                  <i class="fa-brands fa-facebook-f"></i>
                </a>
                <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode(get_permalink()); ?>&text=<?php echo urlencode(get_the_title()); ?>" target="_blank" rel="noopener noreferrer" class="w-12 h-12 border border-white/10 bg-black flex items-center justify-center text-gray-400 hover:text-[#ff5a00] hover:border-[#ff5a00] hover:scale-110 transition-all shadow-md">
                  <i class="fa-brands fa-x-twitter"></i>
                </a>
                <a href="https://api.whatsapp.com/send?text=<?php echo urlencode(get_the_title() . ' ' . get_permalink()); ?>" target="_blank" rel="noopener noreferrer" class="w-12 h-12 border border-white/10 bg-black flex items-center justify-center text-gray-400 hover:text-[#ff5a00] hover:border-[#ff5a00] hover:scale-110 transition-all shadow-md">
            ...
            <div class="border border-white/10 p-8 bg-black text-center relative overflow-hidden group">
              <div class="absolute inset-0 bg-gradient-to-b from-[#ff5a00]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
              ...
              <a href="<?php echo esc_url(home_url('/expeditions')); ?>" class="inline-block w-full bg-[#ff5a00] text-black font-black text-xs py-3.5 tracking-[0.2em] hover:bg-white transition-colors">
                VIEW EXPEDITIONS
              </a>
            </div>
